              ...
              <div class="card mt-3" >
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <form class="form" action="msgsub.php" method="post" role="form" autocomplete="off">
                     <input type="hidden" name="brand1" value="Brown Rice -> lalitha" />
                    <li class="list-group-item"><h6>no.of bags:</h6>
                    <!--<input class="span4 input-big"  name="bags" id="lalithabrand"  style="padding:0px;height:30px;width:80px" size="30" type="number" step="1" pattern="\d+" required=" " />-->
            ...
            <div class="shadow bg-silver rounded"> 
              <div class="card mt-3" >
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <!--<li class="list-group-item d-flex">  -->
                  <form class="form" action="msgsub.php" method="post" role="form" autocomplete="off">
                     <input type="hidden" name="brand1" value="Brownrice -> Lohitha" />
                    <li class="list-group-item"><h6>no.of bags:</h6>
