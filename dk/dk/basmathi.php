    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="contact.html">Contact us</a>
            ...
            <marquee style="color:red">NOTE ** :  Each  bag  containes  25kg of rice</marquee>
    ...
    <div class="row">
        ...
        <div class="col-md-2" >
            ...
            <div class="shadow bg-silver rounded"> 
              <div class="card mt-3" >
                <img class="card-img-top img-thumbnail" src="img/lalitha.jpg" alt="Card image cap">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item" style="font-size:2vw;"><h4>India Gate</h4></li>
                  <!--<li class="list-group-item d-flex">  -->
                  <form class="form" action="msgsub.php" method="post" role="form" autocomplete="off">
                     <input type="hidden" name="brand1" value="Basumathi -> India Gate" />
                    <li class="list-group-item"><h6>no.of bags:</h6>
                    <!--<input class="span4 input-big"  oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" name="bags" id="lalithabrand"  style="padding:0px;height:30px;width:80px" size="30" type="number" required=" " />-->
                  ...
                  <li class="list-group-item"><h6>price:</h6><input  class="span4 input-big" style="padding:0px;height:30px;width:80px" id="total_price_amount" readonly="readonly" name="price" value="999" placeholder="total amount"/></li>
                  <li class="list-group-item"><h6>actual price:</h6><strike>1200</strike></li>
            ...
            <div class="shadow bg-silver rounded"> 
              <div class="card mt-3" >
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <!--<li class="list-group-item d-flex">  -->
                  <form class="form" action="msgsub.php" method="post" role="form" autocomplete="off">
                     <input type="hidden" name="brand1" value="Basumathi -> Lohitha" />
                    <li class="list-group-item"><h6>no.of bags:</h6>
                    ...
                    <!-- <input type="number"  class="input-sm" id="quantity"  name="quantity"  placeholder="quantity" min="1" style="padding:0px;height:30px;width:80px" > -->
                  <li class="list-group-item"><h6>price:</h6><input name="price" class="span4 input-big" style="padding:0px;height:30px;width:80px" id="total_price_amount2" value="999" readonly="readonly" placeholder="total amount"/></li>
